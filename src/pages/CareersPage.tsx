...
const openPositions = [
	{
		...
		location: 'Remote',
		type: 'Flexible',
		description: 'Develop and deploy machine learning models for AI applications.'
	},
	{
		...
		location: 'Remote',
		type: 'Flexible',
		description: 'Work on cutting-edge AI projects and gain hands-on experience.'
	},
	{
				...
				<div className="max-w-7xl mx-auto px-6 lg:px-8">
					<div className="text-center max-w-3xl mx-auto">
						...
						<h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-foreground mb-6">
							Build the Future of <span className="text-[#f37003]">Wellness</span>
						</h1>
						<p className="text-lg text-foreground/60 leading-relaxed">
							Join our mission to make holistic fitness accessible to everyone through innovative
							technology and passionate people.
						</p>
					</div>
				</div>
			</section>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
						{perks.map((perk, index) => (
							...
							>
								...
								<p className="text-sm text-foreground/60 leading-relaxed">{perk.description}</p>
							</Card>
						))}
					</div>
				</div>
					...
					<div className="grid md:grid-cols-2 gap-6">
						{openPositions.map((position, index) => (
							...
							>
								...
								<h3 className="text-2xl font-bold text-foreground mb-4">{position.title}</h3>

								<p className="text-foreground/60 mb-6">{position.description}</p>
				...
				<div className="max-w-3xl mx-auto px-6 lg:px-8">
					...
					<Card className="p-8 lg:p-12 border-border/50 bg-white">
						<form onSubmit={handleSubmit} className="space-y-6">
							...
							<div className="pt-4">
								<Button type="submit" className="w-full bg-[#f37003] hover:bg-[#d86302] text-white">
									Submit Application
								</Button>
							</div>
