...
//   return (
//     <div className="w-full bg-white py-16 px-4 min-h-screen">
//       {/* Mobile View */}
...
//               required
//             />
//             <label className="text-xs text-gray-900">I accept the Terms</label>
//           </div>
...
//                   checked={formData.termsAccepted}
//                   onChange={handleChange}
//                   className="mr-2 h-4 w-4 text-orange-500 border-gray-300 focus:ring-0"
//                   required
//                 />
//                 <label className="text-sm text-black">I accept the Terms</label>
//               </div>
//               {error && <p className="text-red-500 text-sm">{error}</p>}
//               {success && <p className="text-green-500 text-sm">{success}</p>}
//               <button
